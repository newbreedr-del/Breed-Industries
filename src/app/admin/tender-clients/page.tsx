...
const CATEGORIES = [
  'Construction','Civil Engineering','Electrical','Plumbing','IT Services',
  'Consulting','Catering','Security','Cleaning','Logistics','Marketing',
  'Architecture','Landscaping','HVAC','Fire Protection',
];
const PACKAGES = [
