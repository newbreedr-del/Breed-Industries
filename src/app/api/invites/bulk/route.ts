...
export async function POST(req: NextRequest) {
  try {
    ...
    const { recipients, invite_type, expires_hours, max_views, content_title, content_message, send_emails, image_url, background_image_url, event_date, event_location } = body;
