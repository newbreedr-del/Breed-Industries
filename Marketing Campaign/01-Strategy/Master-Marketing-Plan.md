...
- Age 26–45, living in Durban, JHB, CPT, or peri-urban KZN
- Has an idea, a side hustle, or a registered shell of a company
...
- Buys retainers and packaged programs (Learners-to-Leaders style)
- Reached via LinkedIn + email + face-to-face

---

## 3. CHANNEL STRATEGY

| Channel | Role | Frequency | KPI |
|---|---|---|---|
...
| **Paid (Meta + TikTok + Google)** | Amplifier on top of organic | From Day 8 onward | CPL, ROAS |
...
- 4-part series: *Register → Brand → Plan → Build*
- Each part = 1 reel, 1 carousel, 1 LinkedIn long-post, 1 email
- Weekly Live Q&A on IG (Tuesdays 19:00) → repurposed into TikTok shorts
- Begin client testimonial video shoots (target 3 in this window)
...
| **Pure Inspiration** (typography quotes, founder lore) | 5% | "From Idea to Empire" hero posters |
...
- "If you're tired of —"
- "Durban founders:"
- "We just did this for [client] —"

---

## 8. KPIs & TARGETS (90 days)

| Metric | Day-30 | Day-60 | Day-90 |
|---|---:|---:|---:|
| Instagram followers | +800 | +2,500 | +5,000 |
| TikTok followers | +500 | +2,000 | +6,000 |
| Website unique visitors / wk | 600 | 1,500 | 3,000 |
| Quote requests / wk | 8 | 18 | 30 |
...
## 9. BUDGET FRAMEWORK (lean version)

| Line item | Monthly | 90-day |
|---|---:|---:|
| Paid social (Meta + TikTok) | R3,000–R6,000 | R12,000 |
| Google Search (brand + service KW) | R1,500 | R4,500 |
| Print drops (Durban CBD/Umhlanga) | R1,000 | R3,000 |
| Content shoot (founder + 2 clients) | R5,000 once | R5,000 |
| Tools (Canva Pro, Buffer/Later, CapCut Pro) | R600 | R1,800 |
| Influencer micro (1–2 KZN founders) | R2,000 | R6,000 |
| **Total** | **~R13,100** | **~R32,300** |

Scale up when CPL drops below R250 and ROAS clears 3x.

---

## 10. THE 8-AGENT TEAM (who owns what)

| # | Role | Owns |
|---|---|---|
| 1 | Strategy Lead | This plan, KPIs, weekly review |
| 2 | Senior Copywriter | Captions, ads, web copy, email |
| 3 | Social Manager | Calendar, scheduling, engagement, DMs |
| 4 | Graphic Designer | Posters, carousels, story templates |
| 5 | Art Director | Brand consistency, typography, palette |
| 6 | Video Director | Reels/TikToks, shoot direction |
| 7 | Scriptwriter | Hooks, dialogue, on-screen copy |
| 8 | PR / Media Lead | Press release, partnerships, LinkedIn voice |

Weekly stand-up: Mondays 09:00. Asana board lives in the admin panel of the website.

---

## 11. CRISIS / RISK NOTES

- **Negative review or DM** — respond within 4 hours, take to email, never argue publicly.
- **Service delay** — send proactive update before client asks; offer credit on next service.
- **Founder unavailability for shoots** — keep B-roll bank of studio shots and UI mocks.
- **Algorithm dip** — increase posting + boost the strongest 2 organics; don't panic-rebrand.

---

## 12. NEXT 5 ACTIONS (this week)

1. Approve this plan and assign agent owners.
2. Lock the launch date (recommended: next Monday).
3. Shoot the 8 video scripts in **04-Video-Scripts/** in a single half-day at the office.
4. Schedule the first 2 weeks from the calendar in **02-Content-Calendar/** into Buffer or Later.
5. Boot up the launch kit emails in **05-Launch-Kit/** and load to your sending tool.
