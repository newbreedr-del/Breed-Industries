...
The platform replaces the fragmented model that has historically forced new South African business owners to coordinate across registration agents, freelance designers, business plan writers, and developers. By combining these into one accountable team and a self-service Package Builder, The Breed enables founders to receive a transparent, line-itemed quote in under sixty seconds.
...
**Web:** www.thebreed.co.za
**Instagram / TikTok:** @breedindustries
**LinkedIn:** Breed Industries — Premium Growth Agency Durban
**Facebook:** /BREEDinc
...
## 2. FOUNDER ANNOUNCEMENT POST (LinkedIn — long form)

**Headline:** Why we just rebuilt our entire agency.
...
Today we are relaunching as **The Breed Industries** at **thebreed.co.za** — a single platform where you can get registered, branded, planned, and built. Under one roof. With one quote. By one team that actually answers the phone.
...
— Lance
Founder, The Breed Industries
www.thebreed.co.za · +27 60 496 4105 · info@thebreed.co.za

---

## 3. EMAIL SEQUENCE (3 emails)

### EMAIL 1 — Launch Day (send to existing list + WhatsApp contacts)
**Subject line A/B:**
- A: You're invited inside the Empire.
- B: We rebuilt The Breed. Come look.

> Hey [First Name],
>
> Today we're flipping the lights on at **thebreed.co.za**.
>
> One platform. Every service you need to register, brand, plan, and build a real business in South Africa. No more juggling five freelancers, three logo files, and two ignored emails.
>
> **What's new:**
...
### EMAIL 2 — Day +3 ("Founder Friday" promo)
**Subject:** 5 free strategy calls. First come, first booked.

> Quick one.
>
> Every Friday for the next 13 weeks, we're opening **5 free 30-minute strategy calls**. No sales pitch, no slide deck — just one of our directors looking at your business and telling you what we'd actually do first.
>
> Slots vanish fast. To grab one, reply to this email with the word **CALL** or DM us "CALL" on Instagram (@breedindustries).
>
> **[ Or visit thebreed.co.za to build your own package ]**
>
> See you Friday.
>
> — The Breed
...
> Hey [First Name],
>
> Last week three founders asked us the same question: *"What does a 'proper' website actually cost?"*
>
> The honest answer:
>
...
## 4. PLATFORM CAPTIONS (paste-ready)

### INSTAGRAM — Launch post (carousel + reel)
> The new home of Breed is live.
>
...
## 5. PRESS / MEDIA HIT LIST (start here)

| Outlet | Beat | Pitch angle |
|---|---|---|
| Daily Maverick / Business Maverick | SA business | First-of-its-kind all-in-one founder platform out of Durban |
| BusinessTech.co.za | SA tech & business | The Package Builder as a tool story |
| Ventureburn | SA startups | Profile of Lance + agency origin story |
| TechCabal | African tech | Pan-African angle on the founder journey gap |
| ITWeb | SA tech | The platform tech stack and AI portfolio piece |
| The Witness / News24 KZN | Local KZN | Durban founder story, KZN tech / business |
| Capital FM (KZN) | Radio | Lance interview — small business advice slot |
| Smile FM / Vibe FM | Radio | Founder Friday segment partnership |
| LinkedIn Africa | LinkedIn editorial | Founder thought-leadership feature |
...
## 6. INFLUENCER / PARTNER OUTREACH (priority list)

- 2 × Durban-based founder creators (5–50k IG)
- 1 × KZN business radio host
- 1 × ESD/SD program lead at a JSE-listed company
...
## 7. LAUNCH-DAY CHECKLIST (single page — print this)

**T-7 days**
- [ ] Approve all assets in `/03-Posters/` and `/04-Video-Scripts/`
- [ ] Schedule emails 1–3 in your sending tool (Mailchimp / Resend / Sendgrid)
- [ ] Schedule first 14 days of social into Buffer / Later
- [ ] Confirm domain SSL, Package Builder QA, contact form delivery

**T-1 day**
- [ ] WhatsApp broadcast prepped with link
- [ ] Founder filmed selfie-style intro to be the launch reel
- [ ] Press list prepped, embargoed press release sent under embargo to top 3 outlets
- [ ] Internal team aligned on response macros for DMs ("EMPIRE" / "CALL" / "REGISTER")

**Launch day (T)**
- [ ] 09:00 — Press release out to full list + LinkedIn long-post live
- [ ] 09:30 — Email #1 sends
- [ ] 10:00 — IG, FB, TikTok launch posts go live in this order
- [ ] 11:00 — WhatsApp broadcast sends
- [ ] 12:00 — Founder live story Q&A 20-min
- [ ] 17:00 — Story recap of the day's reactions
- [ ] 21:00 — End-of-day metrics screenshot in team chat

**T+1 to T+7**
- [ ] Follow content calendar (Days 1–7 in `/02-Content-Calendar/`)
- [ ] Reply to every comment + DM within 4 hours
- [ ] Test paid ad set (R500 daily) on Day 8
